    ...
    <>
        <div className="bg-slate-100 mx-auto mt-32 mb-16 h-96 w-96 flex rounded-t-xl relative">
            <div className='bg-blue-900 h-48 absolute mt-48 opacity-80 rounded-t-md'>
                ...
                <p className='text-justify text-white font-bold text-md px-10 h-28 mt-5'> {producto.subtitle}. Precio: {producto.price} </p>
            ...
            <img src={producto.img} alt={producto.title} className='mx-auto w-96 rounded-t-xl'/>
        </div>
    </>
    )
}
